...
export default function Sidebar({ tags, selectedTags, onToggleTag, page, onPageChange, onClearFilter, onHome, collapsed, onToggleCollapse }: Props) {
  ...
  return (
    <aside className={`${collapsed ? 'w-16' : 'w-60'} bg-[#0f0f0f] border-r border-[#272727] flex-shrink-0 overflow-y-auto flex flex-col h-full transition-[width] duration-200`}>
      {/* Logo + page pills */}
      ...
      {/* Tag groups — hidden when collapsed */}
      {!collapsed && (
